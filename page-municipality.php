...
<div class="inner">
  ...
  <ul class="tabs">
    <li id="tab01" class=""><a>保育メニュー</a></li>
    <li id="tab02" class="is-active"><a>自治体</a></li>
    <li id="tab03" class=""><a>定期利用</a></li>
  </ul>
</div>
<div class="service-section-wrap">
  <div class="inner">
    <section class="s-service s-menu">
      <div class="heading">
    ...
    <section class="s-service s-municipality is-show">
      <div class="heading">
