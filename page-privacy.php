...
?>
      <div class="inner">
        ...
        <div class="heading">
          ...
          <h2 class="heading__title">プライバシーポリシー</h2>
        </div>
        <div class="sub-container">
          <p class="sub-container__top"> はじめに </p>
          <div class="sub-container__content">
            <div class="sub-container__text">
              <p> ハニークローバー株式会社（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。 </p>
            </div>
          </div>
        </div>
        <div class="terms-box">
          <div class="terms-box__content">
            <h4 class="terms-box__subtitle">第1条（プライバシー情報）</h4>
            ...
            <h4 class="terms-box__subtitle">第2条（プライバシー情報の収集方法）</h4>
            <div class="terms-box__text">
            ...
            <h4 class="terms-box__subtitle">第3条（個人情報を収集・利用する目的）</h4>
            <div class="terms-box__text">
            ...
            <h4 class="terms-box__subtitle">第4条（個人情報の第三者提供）</h4>
            <div class="terms-box__text">
            ...
            <h4 class="terms-box__subtitle">第5条（個人情報の開示）</h4>
            <div class="terms-box__text">
            ...
            <h4 class="terms-box__subtitle">第6条（個人情報の訂正および削除）</h4>
            <div class="terms-box__text">
              <p> ユーザーは，当社の保有する自己の個人情報が誤った情報である場合には，当社が定める手続きにより，当社に対して個人情報の訂正または削除を請求することができます。 当社は，ユーザーから前項の請求を受けてその請求に応じる必要があると判断した場合には，遅滞なく，当該個人情報の訂正または削除を行い，これをユーザーに通知します。 </p>
            </div>
            <h4 class="terms-box__subtitle">第7条（個人情報の利用停止等）</h4>
            <div class="terms-box__text">
            ...
            <h4 class="terms-box__subtitle">第8条（プライバシーポリシーの変更）</h4>
            <div class="terms-box__text">
              <p> 本ポリシーの内容は，ユーザーに通知することなく，変更することができるものとします。 </p>
              <p> 当社が別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。 </p>
            </div>
            <h4 class="terms-box__subtitle">第9条（お問い合わせ窓口）</h4>
            <div class="terms-box__text">
              <p> 本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。 </p>
              <p>住所：東京都港区高輪4丁目1番地18号　高輪ビル4階</p>
              <p>社名：ハニークローバー株式会社</p>
              <p>担当部署：総務部</p>
              <p> Eメールアドレス：<a href="mailto:info@honeyclover.co.jp" target="_blank" rel="noopener noreferrer">info@honeyclover.co.jp</a>
              </p>
            </div>
          </div>
        </div>
